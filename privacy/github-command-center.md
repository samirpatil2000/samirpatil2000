...
To connect to GitHub, the extension asks you to provide a GitHub Personal Access Token. It also retrieves GitHub account, repository, pull request, issue, commit, and activity information that GitHub makes available to that token.

## How information is used

This information is used only to provide the extension's dashboard, repository activity, pull-request views, notifications, and settings. The extension operates in read-only mode and does not modify your GitHub repositories or account.
...
Information remains on your device until you clear the extension's stored data or remove the extension. You can revoke a GitHub token at any time in your GitHub settings.
...
For questions about this policy, contact the publisher through the [Samir Patil GitHub profile](https://github.com/samirpatil2000).
